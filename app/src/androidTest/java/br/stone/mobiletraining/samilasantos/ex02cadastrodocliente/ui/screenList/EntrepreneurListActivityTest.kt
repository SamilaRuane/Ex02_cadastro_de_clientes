...
import br.stone.mobiletraining.samilasantos.ex02cadastrodocliente.ui.UiTest.defineTestRepository
...
class EntrepreneurListActivityTest {
    ...
    fun whenActivityIsLaunched_shouldDisplayAList() {
        defineTestRepository(TestEntrepreneurRepository())
    ...
    fun whenActivityIsLaunched_shouldDisplayNoClientText() {
        defineTestRepository(EmptyEntrepreneurRepository())
